  ...
  return (
    <div>
      <div className="mb-1 flex items-center justify-between gap-2">
        <span className="text-[11px] font-semibold uppercase tracking-wider text-stone-500">Consignes pour l'assistant</span>
      ...
      <p className="mt-1 text-[11px] text-stone-400">L'IA propose une base ; édite-la librement. Ces consignes sont suivies dans tous les messages.</p>
    </div>
  );
}
