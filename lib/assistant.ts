...
export async function generateDraft(
  ...
  const briefing = [
    ...
    // En conversation, l'image envoyée dans le fil bat le lien : pas de clic, pas
    // de sortie de WhatsApp. Le message annonce, Annie joint la carte juste après.
    !gouts.length
      ? "- Les goûts ne sont pas encore choisis : annonce en une phrase que tu envoies la carte des saveurs juste après (Annie joindra l'image), sans recopier la liste des parfums et sans mettre de lien."
      : "",
    "",
