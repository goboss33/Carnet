...
export const AUTOMATIONS: Automation[] = [
  ...
  },
  {
    ...
    family: "cron",
    emoji: "📦",
    name: "Relance post-remise",
    desc: "Peu après l'heure de remise que tu as saisie, le bot demande si le gâteau est livré — un bouton et la commande bascule en « livré » (sans passer par Carnet).",
    trigger: "~N h après l'heure de remise, à la minute près",
    example: "📦 Le gâteau de Sonia (anniversaire), remis à 14:00 — c'est livré ?\n[✅ Livré] [⏰ Plus tard]",
    setting: "cronHandover",
    testKind: "handover",
    delays: [{ name: "postHandoverHours", label: "Demander après l'heure de remise", unit: "h", min: 1, max: 12, def: 1 }],
    stage: 4,
  },
  {
    id: "journal",
    ...
    family: "cron",
    emoji: "📰",
    name: "Pages du site programmées",
    desc: "Publie les pages du Journal (Studio → Pages du site) à l'heure prévue, prévient le site pour qu'il se mette à jour et t'envoie le lien.",
    trigger: "À la minute prévue lors de la programmation",
    example: "📰 Page publiée : Gâteau licorne arc-en-ciel — anniversaire à Pully\nhttps://mamangateau.ch/creations/gateau-licorne-arc-en-ciel-pully",
    setting: "cronJournal",
    testKind: "journal",
    stage: 4,
  },
  {
    ...
    family: "cron",
    emoji: "🎨",
    name: "Vigie des thèmes",
    desc: "Compare les thèmes réellement saisis par les clientes à la base de suggestions du configurateur du site, et te signale ceux qui manquent — la base s'enrichit de la vraie demande.",
    trigger: "Tous les N jours, avec le digest du matin",
    example: "🎨 Vigie des thèmes — 3 saisies absentes des suggestions :\n• « axolotl pastel » (2×)\n• « pat patrouille rose » (1×)\nÀ ajouter dans la base du configurateur si pertinent.",
    setting: "cronThemes",
    testKind: "themes",
    delays: [{ name: "themeCheckDays", label: "Fréquence du check", unit: "j", min: 7, max: 90, def: 30 }],
  },
  {
    id: "gsc",
    icon: "Search",
    family: "cron",
    emoji: "🔎",
    name: "Vigie Search Console",
    desc: "Les requêtes Google réelles qui affichent ton site : ce qui monte, les idées de pages à créer (vues mais sans page dédiée) et la performance des pages du Journal.",
    trigger: "Tous les N jours, avec le digest du matin",
    example: "🔎 Search Console — 14 derniers jours\n12 clics · 480 affichages\n💡 Idées : « gâteau sans gluten lausanne » — 22 aff., pos. 18",
    setting: "cronGsc",
    testKind: "gsc",
    delays: [{ name: "gscCheckDays", label: "Fréquence du rapport", unit: "j", min: 7, max: 90, def: 14 }],
  },
  {
    id: "monthly",
    icon: "TrendingUp",
  ...
  },
  {
    ...
    family: "command",
    emoji: "💰",
    name: "Enregistrer un acompte",
    desc: "Depuis le menu, choisis une commande et note l'acompte reçu — elle passe en « acompte reçu » sans ouvrir Carnet.",
    trigger: "Menu ☰ → Enregistrer un acompte",
  },
  {
    id: "cancel-menu",
    icon: "Ban",
    ...
    desc: "Depuis le menu, classe une commande sans suite. Si un acompte avait été versé, le bot demande si tu l'as gardé, remboursé ou partiellement remboursé (recette ajustée).",
    trigger: "Menu ☰ → Annuler une commande",
  },
  {
    id: "menu",
    icon: "LayoutGrid",
